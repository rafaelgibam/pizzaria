...
CREATE TABLE IF NOT EXISTS `pizzaria`.`PEDIDO_DELIVERY` (
  ...
  INDEX `fk_PEDIDO_DELIVERY_PRODUTO1_idx` (`PRODUTO_ID` ASC),
  CONSTRAINT `fk_PEDIDO_DELIVERY_PRODUTO1`
...
CREATE TABLE IF NOT EXISTS `pizzaria`.`PEDIDO_PRESENCIAL` (
  ...
  `CLIENTE_ID` INT NOT NULL,
  `PRODUTO_ID` INT NOT NULL,
  PRIMARY KEY (`ID`, `GARCOM_ID`, `MESA_ID`, `CLIENTE_ID`, `PRODUTO_ID`),
  ...
  INDEX `fk_PEDIDO_PRESENCIAL_PRODUTO1_idx` (`PRODUTO_ID` ASC),
  ...
  CONSTRAINT `fk_PEDIDO_PRESENCIAL_CLIENTE1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PEDIDO_PRESENCIAL_PRODUTO1`
    FOREIGN KEY (`PRODUTO_ID`)
    REFERENCES `pizzaria`.`PRODUTO` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
