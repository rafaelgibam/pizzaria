...
CREATE TABLE IF NOT EXISTS `pizzaria`.`ENDERECO` (
  ...
  `NOMERUA` VARCHAR(255) NULL,
  `NUMCASA` VARCHAR(10) NULL,
...
CREATE TABLE IF NOT EXISTS `pizzaria`.`MOTOBOY` (
  ...
  `RG` VARCHAR(45) NULL,
  PRIMARY KEY (`ID`, `ENDERECO_ID`),
  INDEX `fk_MOTOBOY_ENDERECO1_idx` (`ENDERECO_ID` ASC),
  CONSTRAINT `fk_MOTOBOY_ENDERECO1`
    FOREIGN KEY (`ENDERECO_ID`)
    REFERENCES `pizzaria`.`ENDERECO` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `pizzaria`.`GARCOM` (
  ...
  `RG` VARCHAR(45) NULL,
  PRIMARY KEY (`ID`, `ENDERECO_ID`),
  INDEX `fk_GARCOM_ENDERECO1_idx` (`ENDERECO_ID` ASC),
  CONSTRAINT `fk_GARCOM_ENDERECO1`
    FOREIGN KEY (`ENDERECO_ID`)
    REFERENCES `pizzaria`.`ENDERECO` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `pizzaria`.`COZINHEIRO` (
  ...
  `RG` VARCHAR(45) NULL,
  PRIMARY KEY (`ID`, `ENDERECO_ID`),
  INDEX `fk_COZINHEIRO_ENDERECO1_idx` (`ENDERECO_ID` ASC),
  CONSTRAINT `fk_COZINHEIRO_ENDERECO1`
    FOREIGN KEY (`ENDERECO_ID`)
    REFERENCES `pizzaria`.`ENDERECO` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `pizzaria`.`ENTRADA_PRODUTO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pizzaria`.`ENTRADA_PRODUTO` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `QTD` INT NULL,
  `PRODUTO_ID` INT NOT NULL,
  `COZINHEIRO_ID` INT NOT NULL,
  PRIMARY KEY (`ID`, `PRODUTO_ID`, `COZINHEIRO_ID`),
  INDEX `fk_FORNECEDOR_has_PRODUTO_PRODUTO1_idx` (`PRODUTO_ID` ASC),
  INDEX `fk_ENTRADA_PRODUTO_COZINHEIRO1_idx` (`COZINHEIRO_ID` ASC),
  CONSTRAINT `fk_FORNECEDOR_has_PRODUTO_PRODUTO1`
    FOREIGN KEY (`PRODUTO_ID`)
    REFERENCES `pizzaria`.`PRODUTO` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ENTRADA_PRODUTO_COZINHEIRO1`
